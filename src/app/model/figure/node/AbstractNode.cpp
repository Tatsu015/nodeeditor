...
QString AbstractNode::name() const { return m_name; }

void AbstractNode::setName(const QString& name) { m_name = name; }

qreal AbstractNode::top() const { return sceneBoundingRect().top(); }

qreal AbstractNode::bottom() const { return sceneBoundingRect().bottom(); }

qreal AbstractNode::right() const { return sceneBoundingRect().right(); }
...
QList<Port*> AbstractNode::ports() const { return m_ports; }

void AbstractNode::addPort(Port* port) { m_ports << port; }
